...
# 情感关键词映射（精简高确定性版）
EMOTION_KEYWORDS = {
    "happy": ["happy", "glad", "joy", "love", "wonderful", "great", "excited", "fantastic", "perfect", "haha", "lol"],
    "sad": ["sad", "cry", "tears", "depressed", "miss", "unhappy", "lonely", "hurt", "pain", "sorry"],
    "angry": ["angry", "mad", "hate", "rage", "furious", "annoyed", "stupid", "idiot"],
    "surprised": ["wow", "surprised", "shocked", "omg", "unexpected", "amazing"],
    "thinking": ["think", "wonder", "consider", "maybe", "hmm", "not sure", "curious"],
    "scared": ["scared", "afraid", "fear", "worried", "nervous", "anxious", "terrified"],
    "embarrassed": ["embarrassed", "awkward", "blush", "shy", "mistake", "oops"],
    "confused": ["confused", "puzzled", "don't understand", "unclear", "strange"],
    "neutral": [],
    # 中文关键词（精简）
    "happy_zh": ["开心", "高兴", "快乐", "幸福", "太好", "哈哈", "棒", "完美", "喜欢"],
    "sad_zh": ["伤心", "难过", "悲伤", "哭", "眼泪", "抑郁", "失落", "痛苦", "遗憾"],
    "angry_zh": ["生气", "愤怒", "讨厌", "可恶", "恨", "气死了", "烦", "讨厌"],
    "surprised_zh": ["哇", "震惊", "没想到", "居然", "意想不到", "什么情况"],
    "thinking_zh": ["想", "思考", "考虑", "也许", "可能", "估计", "琢磨"],
    "scared_zh": ["害怕", "恐惧", "担心", "紧张", "可怕", "危险", "不安"],
    "embarrassed_zh": ["尴尬", "害羞", "不好意思", "脸红", "丢人", "糗"],
    "confused_zh": ["困惑", "不明白", "不清楚", "什么意思", "搞不懂", "迷糊", "懵"],
}
...
class TagGenerator:
    ...
    支持多语言关键词检测和LLM解析。
    支持通过 emotion_mode 切换解析模式："keyword" 或 "llm"。
    """
    ...
    def __init__(
        ...
        Args:
            ...
            emotion_mode: 情感解析模式，"keyword" 或 "llm"
        """
    ...
    def set_emotion_mode(self, mode: str) -> None:
        ...
        if mode not in ("keyword", "llm"):
            raise ValueError(f"emotion_mode must be 'keyword' or 'llm', got '{mode}'")
        self.emotion_mode = mode

    def set_llm_callable(self, llm_callable: Callable[[str], str]) -> None:
        """设置LLM调用函数。
