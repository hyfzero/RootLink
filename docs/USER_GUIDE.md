...
| 系统 | Android 9.0 及以上 |
| 网络 | 对话功能需要访问所选模型提供商 |
| 模型账号 | MiniMax、DeepSeek、Qwen 或 GLM API Key |
...
| Qwen | Qwen 3.6 Flash、Qwen 3.7 Max | 阿里云百炼兼容接口，国内线路优先 |
| GLM | GLM-5.1、GLM-4.7、GLM-4.5、GLM-4 Flash | 智谱 GLM 系列对话与国内 API 线路 |

建议首次使用优先选择响应稳定、成本可控的 Flash 类型模型，例如 DeepSeek V4 Flash、Qwen 3.6 Flash 或 GLM-4 Flash。
