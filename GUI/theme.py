...
def palette(is_dark: bool) -> dict[str, str]:
    if is_dark:
        return {
            ...
            "surface_solid": "#25202E",
            "surface_solid_alt": "#2D2738",
            "dropdown_surface": "#2B2634",
            "dropdown_border": hex_with_alpha("#FFFFFF", 0x24),
    ...
    return {
        ...
        "surface_solid_alt": "#F8F6FB",
        "dropdown_surface": "#FFFFFF",
        "dropdown_border": hex_with_alpha("#3B334A", 0x20),
