...
DEFAULT_ROLE_DATA = [
    {
        "id": "amadeus",
        "name": "Amadeus",
        "type": "Rational Memory",
        "tags": ["Calm", "Precise", "Intelligent"],
        "intro": "Calm and precise, with a distant but reliable tone.",
        "status_text": "I remember where we paused.",
        "accent_color": "#B6A8C9",
        "avatar_path": resource_path("amadues.png"),
        "standing_image_path": resource_path("amadues_Full_profile.png"),
        "last_message": "How did today's experiment go?",
        "last_time": "2h ago",
    },
    {
        "id": "shinji",
        "name": "Shinji",
        "type": "Quiet Listener",
        "tags": ["Sensitive", "Gentle", "Empathetic"],
        "intro": "Doesn't overtalk. Listens carefully until you finish.",
        "status_text": "I'll wait quietly.",
        "accent_color": "#AEB8C7",
        "avatar_path": resource_path("Shinji.png"),
        "standing_image_path": resource_path("Shinji_Ikari_full_profile.png"),
        "last_message": "I understand that feeling.",
        "last_time": "Yesterday",
    },
    {
        "id": "asuka",
        "name": "Asuka",
        "type": "Sharp Companion",
        "tags": ["Confident", "Direct", "Energetic"],
        "intro": "Sharp words, but never leaves you unsupported.",
        "status_text": "Ready to catch your emotions.",
        "accent_color": "#D99A96",
        "avatar_path": resource_path("Asuka.png"),
        "standing_image_path": resource_path("Asuka_full_profile.png"),
        "last_message": "Don't hold it alone. Talk to me.",
        "last_time": "3d ago",
    },
]
